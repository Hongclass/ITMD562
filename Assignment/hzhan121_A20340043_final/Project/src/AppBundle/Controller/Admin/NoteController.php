...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('admin/note/index.html.twig', array('posts' => $posts));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('admin/note/new.html.twig', array(
            'post' => $post,
    ...
    public function showAction(Post $post)
    {
        ...
        if (null === $this->getUser() || !$post->isAuthor($this->getUser())) {
            throw $this->createAccessDeniedException('Notes can only be shown to their authors.');
        }

        $deleteForm = $this->createDeleteForm($post);

        return $this->render('admin/note/show.html.twig', array(
            'post'        => $post,
    ...
    {
        if (null === $this->getUser() || !$post->isAuthor($this->getUser())) {
            throw $this->createAccessDeniedException('Notes can only be edited by their authors.');
        }
     ...
     * from GET and POST. Since the controller that removes the note posts expects
